<template>
  <!-- component -->
  <div
    class="flex items-center justify-center w-full h-screen p-5 bg-opacity-50 backgroundcolor md:px-40 lg:px-0 lg:h-full lg:p-0"
  >
    <div
      class="flex flex-col w-full overflow-hidden bg-indigo-500 rounded-md shadow-lg lg:shadow-none max md:flex-row lg:min-h-screen md:flex-1"
    >
      <div
      ...
      >
        ...
        <div
          class="flex flex-col items-center justify-center w-full mt-10 text-center"
        >
